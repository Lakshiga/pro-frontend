...
const AdminDashboard = () => {
  ...
  // Filter organizers, payments, and users based on search term
  ...
  return (
    <div className="min-vh-100" style={{ backgroundColor: '#000000', color: '#FFFFFF', padding: '2rem' }}>
      <div className="container">
        <motion.header initial={{ opacity: 0, y: -50 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} className="d-flex justify-content-between align-items-center mb-5">
          ...
          <motion.button whileHover={{ scale: 1.05, boxShadow: '0 0 15px rgba(204, 255, 0, 0.5)' }} whileTap={{ scale: 0.95 }}
            className="btn fw-bold"
            onClick={handleLogout}
            style={{ backgroundColor: '#CCFF00', color: '#000000', border: 'none', padding: '0.5rem 1rem', borderRadius: '5px' }}>
            Logout
          </motion.button>
        </motion.header>
        ...
        <div className="row g-4 mb-4">
          {[
            ...
            <motion.div  key={index}  initial={{ opacity: 0, y: 20 }}  animate={{ opacity: 1, y: 0 }}  transition={{ duration: 0.3, delay: index * 0.1 }} className="col-md-6 col-lg-3">
              <motion.div
                whileHover={{ scale: 1.05, boxShadow: '0 0 20px rgba(204, 255, 0, 0.3)' }}
                className="p-3 rounded"
                style={{  backgroundColor: '#111111',  border: '2px solid #CCFF00', boxShadow: '0 0 10px rgba(204, 255, 0, 0.1)', }} >
        ...
        <div className="mb-4">
          ...
          <div className="input-group">
            ...
            <input
              ...
              style={{ backgroundColor: '#111111',  color: '#FFFFFF',  border: '1px solid #CCFF00', }} />
          </div>
        </div>
        ...
        {loading ? (
          ...
          <>
            {activeTab === 'organizers' && (
              <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.5 }} className="rounded shadow-sm overflow-hidden"
                          ...
                          <tr key={payment._id}>
                            ...
                            <td>
                              {payment.status === 'pending' && (
                                <motion.button whileHover={{ scale: 1.05, boxShadow: '0 0 10px rgba(204, 255, 0, 0.5)' }} whileTap={{ scale: 0.95 }}
